...
export default function Footer() {
  ...
  return (
    <footer className="bg-foreground dark:bg-foreground text-white pt-16 pb-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 dark:text-white/70 mb-6 text-sm">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-9 h-9 bg-white/10 dark:bg-white/10 rounded-full flex items-center justify-center text-white hover:bg-primary transition-colors duration-300">
