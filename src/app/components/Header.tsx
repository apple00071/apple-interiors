    ...
    <>
      ...
      {isMenuOpen && (
        <motion.div 
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 bg-black/60 z-[90] md:hidden mobile-menu-overlay"
      ...
      <motion.div
        ...
        className={`fixed top-[4rem] left-0 right-0 ${menuBgColor} backdrop-blur-lg md:hidden overflow-hidden shadow-lg z-[95] mobile-scroll`}
      >
        <nav className="container mx-auto py-6 px-4 overflow-y-auto h-full">
          ...
          >
            ...
            <div className="flex space-x-4">
              <a href="#" className={`w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center ${menuTextColor}`}>
