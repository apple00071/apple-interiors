...
interface PathProps extends React.SVGAttributes<SVGPathElement> {
  d?: string;
}
...
export default function WhatsAppWidget() {
  ...
  return (
    <a
      ...
      className={`fixed bottom-8 right-8 bg-green-500 text-white rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 z-50 flex items-center ${
    ...
    >
      ...
      {isExpanded && (
        <span className="ml-2 font-medium whitespace-nowrap">Chat with us</span>
      )}
    </a>
  );
} 