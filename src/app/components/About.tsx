      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            {/* Stats */}
            <div className="absolute -bottom-12 left-1/2 -translate-x-1/2 w-[90%] bg-white dark:bg-gray-800 rounded-xl shadow-xl p-6 grid grid-cols-2 md:grid-cols-4 gap-4">
