...
export const metadata: Metadata = {
  ...
  description: 'Top Interior Design Company in Hyderabad with 7 years of experience. Residential & Commercial Interiors, Modular Kitchen, False Ceiling. Get Free Quote!',
