...
export async function POST(request) {
  try {
    console.log('Request URL (trailing slash):', request.url);
    console.log('Request method:', request.method);
    
    // Parse request body
    const body = await request.json();
    console.log('Contact form submission received (trailing slash):', body);
...
export async function OPTIONS(request) {
  console.log('OPTIONS request received (trailing slash):', request.url);
